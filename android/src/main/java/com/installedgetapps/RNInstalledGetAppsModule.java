...
package com.winplaybox.installedgetapps;
...
public class RNInstalledGetAppsModule extends ReactContextBaseJavaModule {

  private final ReactApplicationContext reactContext;

  public RNInstalledGetAppsModule(ReactApplicationContext reactContext) {
    super(reactContext);
